...
def testing(path,device):
    ...
    test_hits = pd.read_csv('/share/hel/datasets/jobiqo/talent.com/JobRec/BM25/test_hits.txt', sep=' ', header=None, names=['query_id', 'Q0', 'doc_id', 'rank', 'score','Anserini'])
